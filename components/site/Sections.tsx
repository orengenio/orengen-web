...
const SECTORS = [
  ...
  { step: "04 · Enterprise", h3: "Owned operations infrastructure for growth-stage and mid-market operators.", p: "Replace fragmented tools with a governed AI operating layer that consolidates workflows and data surfaces.", ul: ["Workflow orchestration", "Automation modernization", "Executive operating dashboards"], trust: "No-rent methodology · Owned systems", href: "/orenconsulting", link: "View Consulting" },
